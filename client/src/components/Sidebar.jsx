...
import { LayoutDashboard, Users, CreditCard, History, Settings, LogOut, Wallet } from 'lucide-react'
...
const Sidebar = () => {
  ...
  const links = [
    ...
    { name: 'Bank Details', icon: CreditCard, path: '/parent/bank' },
    { name: 'Transactions', icon: History, path: '/parent/transactions' },
